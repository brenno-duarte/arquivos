    ...
    <div class="card-body">
        ...
        <form class="form-signin mt-4" method="POST" action="#">
            ...
            <div class="txt-3 text-center font-2 m-4">
                ...
                Foi enviado um link para o seu e-mail para recuperação de senha
            </div>
            
            <div class="form-group">
                <input type="email" id="email" class="input-class" name="email" placeholder="Digite seu e-mail" required
                    autofocus>
            </div>
