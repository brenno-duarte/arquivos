...
$app->get('/admin/gerenciar-usuarios', function($request, $response){
    ...
    if ($_SESSION['idAdm'] && $_SESSION['acesso'] == 'Administrador') {
        ...
        return $this->view->render($response, "views-gestor/gerenciar-usu.html", [
...
$app->get('/admin/novo-usuario', function($request, $response){
    ...
    if ($_SESSION['idAdm'] && $_SESSION['acesso'] == 'Administrador') {
        ...
        return $this->view->render($response, "views-gestor/novo-usuario.html", [
            'title' => 'Novo Usuário',
            'usuarios' => $usuarios,
            'msg1' => $msg1,
            'msg2' => $msg2,
...
$app->get('/admin/editar-usuario/{id}', function($request, $response, $args){
    ...
    if ($_SESSION['idAdm'] && $_SESSION['acesso'] == 'Administrador') {
        ...
        return $this->view->render($response, "views-gestor/editar-usuario.html", [
