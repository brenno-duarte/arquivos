...
class BlogDAO {
    ...
    public function getNoticia(int $id){
        $sql = "SELECT * FROM tb_blog WHERE idNot = $id";
    ...
    public function insert(Blog $blog){
        $sql = "INSERT INTO tb_blog (titulo, resumo, autor, imagem, nome_imagem, conteudo, data_not) 
        VALUES (:titulo, :resumo, :autor, :imagem, :nome_imagem, :conteudo, :data_not)";
