...
class BlogController {
    ...
    public function inserir($titulo, $resumo, $autor, $conteudo, $dataFormatada, $novoNome, $nome_imagem){
        $blogDAO = new BlogDAO();
        $blog = new Blog();
    ...
    public function alterar($titulo, $resumo, $autor, $conteudo, $dataFormatada, $novoNome, $nome_imagem, int $id){
        $blogDAO = new BlogDAO();
        $blog = new Blog();
        $blog->setTitulo($titulo);
        $blog->setResumo($resumo);
